...
本地 `python3 -m unittest discover -s tests -v` 当前为 `27/27` 通过，在原 22 项之上新增方向感知离开判定 (ADR 0046)、MACD 前缀和、证据身份含结构时间、候选延伸不触发历史回放 (ADR 0047) 与生命周期账本默认关闭 (ADR 0048) 五项契约。它是源码契约检查，不替代 Pine 合成夹具或官方运行时。
